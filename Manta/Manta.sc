...
//		);
	...
	addToSetup {Ê|setupName, type, key, func|Êsetups[setupName][\indiv][type].put(key, func) }
	removeFromSetup {Ê|setupName, type, key|Êsetups[setupName][\indiv][type].put(key,Ênil) }
