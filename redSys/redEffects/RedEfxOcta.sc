//redFrik - adapter from sean costello's old-skool emulation of the Boss OC-2 pedal, sc-users 060723

RedEfxOcta : RedEffectModule {
	*def {
		^SynthDef(\redEfxOcta, {|out= 0, mix= -1, cutoff= 440, oct1= 1, oct2= 0|
			var dry, wet, o1, o2;
			dry= In.ar(out, 2);
			wet= LPF.ar(dry, cutoff);
			o1= ToggleFF.ar(wet);
			o2= ToggleFF.ar(o1);
