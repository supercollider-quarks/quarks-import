{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 74.0, 205.0, 533.0, 605.0 ],
		"bglocked" : 0,
		"defrect" : [ 74.0, 205.0, 533.0, 605.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 135.0, 235.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 90.0, 261.0, 34.0 ],
					"text" : "First arguments gives node name. Subsequent arguments specify node(s) to subscribe to."
				}
