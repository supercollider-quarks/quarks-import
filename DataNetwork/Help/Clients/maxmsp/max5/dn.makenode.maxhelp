{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 517.0, 343.0, 533.0, 449.0 ],
		"bglocked" : 0,
		"defrect" : [ 517.0, 343.0, 533.0, 449.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 195.0, 127.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 240.0, 63.0, 20.0 ],
					"text" : "s dn.node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 150.0, 32.5, 18.0 ],
					"text" : "9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 150.0, 32.5, 18.0 ],
					"text" : "0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 300.0, 94.0, 18.0 ],
					"text" : "999 \"0\" \"0\" \"0\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 270.0, 77.0, 20.0 ],
					"text" : "dn.node 999"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 135.0, 207.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "dn.makenode 999 3 TestData"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 375.0, 247.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Arguments: Node, Number of Slots, and Name of the Node"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 54.5, 147.0, 99.5, 147.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 54.5, 147.0, 144.5, 147.0 ],
					"source" : [ "obj-21", 0 ]
				}
