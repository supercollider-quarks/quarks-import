{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 1443.0, 830.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 1443.0, 830.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 180.0, 165.0, 293.0, 20.0 ],
									"text" : "unpack s i i"
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 297.0, 44.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 297.0, 44.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 315.0, 225.0, 30.0, 20.0 ],
									"text" : "t 11"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 270.0, 225.0, 24.0, 20.0 ],
									"text" : "t 6"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 270.0, 195.0, 108.0, 20.0 ],
									"text" : "sel pwm digital"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 270.0, 165.0, 129.0, 20.0 ],
									"text" : "t s s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 270.0, 198.0, 20.0 ],
									"text" : "pack i i s"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 1 ],
									"hidden" : 0,
									"midpoints" : [ 324.5, 257.0, 279.0, 257.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 2 ],
									"hidden" : 0,
									"midpoints" : [ 389.5, 257.0, 368.5, 257.0 ],
									"source" : [ "obj-7", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 930.0, 345.0, 345.0, 20.0 ],
					"text" : "minibee <clientID> <nodename> <minibeeID> <output/custom>"
				}
