{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1003.0, 221.0, 672.0, 606.0 ],
		"bglocked" : 0,
		"defrect" : [ 1003.0, 221.0, 672.0, 606.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 390.0, 390.0, 42.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-15",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"types" : [  ],
					"patching_rect" : [ 210.0, 330.0, 108.0, 20.0 ],
					"numoutlets" : 3,
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 345.0, 330.0, 32.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-23",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 270.0, 390.0, 42.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-19",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 255.0, 360.0, 139.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-14",
					"fontname" : "Arial",
					"patcher" : 					{
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "If only name is given, left outlet will not work.",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 240.0, 285.0, 235.0, 34.0 ],
					"numoutlets" : 0,
					"id" : "obj-32",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "\"add\" and \"remove\" messages can be used to dynamically change the subscriptions.",
					"linecount" : 3,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 240.0, 225.0, 235.0, 48.0 ],
					"numoutlets" : 0,
					"id" : "obj-31",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 90.0, 330.0, 74.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-29",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 330.0, 54.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-28",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 390.0, 115.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-26",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "dn.node max_client",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 360.0, 115.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-3",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Left outlet outputs data from node corresponding to first argument.\nRight outlet outputs data from all nodes specified with arguments, preceeded by their node ID.",
					"linecount" : 5,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 240.0, 145.0, 235.0, 75.0 ],
					"numoutlets" : 0,
					"id" : "obj-7",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 480.0, 63.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 450.0, 32.5, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-12",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 105.0, 450.0, 130.0, 62.0 ],
					"numoutlets" : 0,
					"id" : "obj-9",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 525.0, 247.0, 48.0 ],
					"numoutlets" : 0,
					"id" : "obj-11",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "First argument is the name of the client. Subsequent arguments specify node(s) to subscribe to.",
					"linecount" : 3,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 240.0, 88.0, 240.0, 48.0 ],
					"numoutlets" : 0,
					"id" : "obj-10",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "100 0.010743 0.168719 0.436123 0.891518 0.078514 0.603039 0.331542 0.539593 0.609754 0.215403",
					"linecount" : 5,
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 240.0, 161.0, 73.0 ],
					"numoutlets" : 1,
					"id" : "obj-4",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "dn.node max_client 100 777",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 210.0, 161.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-8",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 165.0, 121.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-5",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"args" : [  ],
					"numinlets" : 0,
					"patching_rect" : [ 315.0, 435.0, 211.0, 145.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 501.0, 15.0, 4.0, 411.0 ],
					"numoutlets" : 0,
					"id" : "obj-60"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 39.5, 159.5, 141.5, 159.5 ]
				}
